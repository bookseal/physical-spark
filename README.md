...
- [**Global market — who pays**](docs/02-market/global-market.md) — Korea / US / Singapore run on three different engines (state budget, enterprise L&D, state credit via an institution), with sourced 2026 numbers — and the place the standard advice is **wrong**: a six-week online cohort is *not* SkillsFuture-eligible in Singapore. Live page: [market.html](docs/02-market/global-market.md).
