...
>
> **웹 버전 (브라우저에서 바로 읽기):** 개념 배경은 [Ground Control](../../site/courses/ground-school.html) — 모든 용어·수학·80개 함정을 실습 전에 읽는 ~10시간 코스. 실습은 [Pat me on the back (hands-on)](../../site/courses/pat-me-on-the-back.html) — 체크포인트 단위로 따라 하는 버전.
